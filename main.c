...
void Task2(void *pvParameters) {
    for (;;)
    {
        ...
        vTaskDelay(5000 / portTICK_PERIOD_MS); // Delay for 2 seconds
    }
}

// Function that represents the terceira task
void Task3(void *pvParameters) {
    for (;;)
    {
        ...
        vTaskDelay(5000 / portTICK_PERIOD_MS); // Delay for 2 seconds
        xTaskCreate(StopTask, "StopTask", configMINIMAL_STACK_SIZE, NULL, 3, NULL);
    }
}
